...
// PG_OSD_CONFIG
    ...
    { "osd_rssi_1_pos",             VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_RSSI_X_VALUE]) },
#ifdef USE_RX_LINK_QUALITY_INFO
